export default {
  ...
  keys: {
    ...
    copyPageKeys: "Copy Page Keys",
    pageKeysCopied: "Copied {count} keys to clipboard",
    noPageKeysToCopy: "No keys to copy on current page",
    ...
    validateFailedKeys: "Validate Failed Keys",
